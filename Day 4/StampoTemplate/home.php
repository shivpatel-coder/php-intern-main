...
<body>
    <?php
      include './Themeparts/menu.php';
      include './Themeparts/header.php';
    ?>
...
<div id="wrapper"> 
	...
	<div id="page">
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">Welcome to Akash Khatri </a></h2>
				<p class="meta"><span class="date">June 04, 2021</span><span class="posted">Posted by <a href="#">Akash</a></span></p>
